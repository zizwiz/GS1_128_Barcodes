    ...
    public partial class Form1
    {
        ...
        private void cmbobx_ai_test_data_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (cmbobx_ai_test_data.SelectedItem)
            {
                ...
                case "AI 314n: AREA (m2)": txtbx_data_input.Text = ""; return;
                case "AI 315n: NET VOLUME (l)": txtbx_data_input.Text = ""; return;
                case "AI 316n: NET VOLUME (m3)": txtbx_data_input.Text = ""; return;
                case "AI 320n: NET WEIGHT (lb)": txtbx_data_input.Text = ""; return;
                case "AI 321n: LENGTH (i)": txtbx_data_input.Text = ""; return;
                case "AI 322n: LENGTH (f)": txtbx_data_input.Text = ""; return;
                case "AI 323n: LENGTH (y)": txtbx_data_input.Text = ""; return;
                case "AI 324n: WIDTH (i)": txtbx_data_input.Text = ""; return;
                case "AI 325n: WIDTH (f)": txtbx_data_input.Text = ""; return;
                case "AI 326n: WIDTH (y)": txtbx_data_input.Text = ""; return;
                case "AI 327n: HEIGHT (i)": txtbx_data_input.Text = ""; return;
                case "AI 328n: HEIGHT (f)": txtbx_data_input.Text = ""; return;
                case "AI 329n: HEIGHT (y)": txtbx_data_input.Text = ""; return;
                case "AI 330n: GROSS WEIGHT (kg)": txtbx_data_input.Text = ""; return;
                case "AI 331n: LENGTH (m), log": txtbx_data_input.Text = ""; return;
                case "AI 332n: WIDTH (m), log": txtbx_data_input.Text = ""; return;
                case "AI 333n: HEIGHT (m), log": txtbx_data_input.Text = ""; return;
                case "AI 334n: AREA (m2), log": txtbx_data_input.Text = ""; return;
                case "AI 335n: VOLUME (l), log": txtbx_data_input.Text = ""; return;
                case "AI 336n: VOLUME (m3), log": txtbx_data_input.Text = ""; return;
                case "AI 337n: KG PER m²": txtbx_data_input.Text = ""; return;
                case "AI 340n: GROSS WEIGHT (lb)": txtbx_data_input.Text = ""; return;
                case "AI 341n: LENGTH (i), log": txtbx_data_input.Text = ""; return;
                case "AI 342n: LENGTH (f), log": txtbx_data_input.Text = ""; return;
                case "AI 343n: LENGTH (y), log": txtbx_data_input.Text = ""; return;
                case "AI 344n: WIDTH (i), log": txtbx_data_input.Text = ""; return;
                case "AI 345n: WIDTH (f), log": txtbx_data_input.Text = ""; return;
                case "AI 346n: WIDTH (y), log": txtbx_data_input.Text = ""; return;
                case "AI 347n: HEIGHT (i), log": txtbx_data_input.Text = ""; return;
                case "AI 348n: HEIGHT (f), log": txtbx_data_input.Text = ""; return;
                case "AI 349n: HEIGHT (y), log": txtbx_data_input.Text = ""; return;
                case "AI 350n: AREA (i2)": txtbx_data_input.Text = ""; return;
                case "AI 351n: AREA (f2)": txtbx_data_input.Text = ""; return;
                case "AI 352n: AREA (y2)": txtbx_data_input.Text = ""; return;
                case "AI 353n: AREA (i2), log": txtbx_data_input.Text = ""; return;
                case "AI 354n: AREA (f2), log": txtbx_data_input.Text = ""; return;
                case "AI 355n: AREA (y2), log": txtbx_data_input.Text = ""; return;
                case "AI 356n: NET WEIGHT (t)": txtbx_data_input.Text = ""; return;
                case "AI 357n: NET VOLUME (oz)": txtbx_data_input.Text = ""; return;
                case "AI 360n: NET VOLUME (q)": txtbx_data_input.Text = ""; return;
                case "AI 361n: NET VOLUME (g)": txtbx_data_input.Text = ""; return;
                case "AI 362n: VOLUME (q), log": txtbx_data_input.Text = ""; return;
                case "AI 363n: VOLUME (g), log": txtbx_data_input.Text = ""; return;
                case "AI 364n: VOLUME (i3)": txtbx_data_input.Text = ""; return;
                case "AI 365n: VOLUME (f3)": txtbx_data_input.Text = ""; return;
                case "AI 366n: VOLUME (y3)": txtbx_data_input.Text = ""; return;
                case "AI 367n: VOLUME (i3), log": txtbx_data_input.Text = ""; return;
                case "AI 368n: VOLUME (f3), log": txtbx_data_input.Text = ""; return;
                case "AI 369n: VOLUME (y3), log": txtbx_data_input.Text = ""; return;
